...
def main():
    ...
    options = [["[0] welcome","welcome",""],
            ...
            ["[62] Oversterfte GAM","oversterfte_predict_per_levensjaar_nieuw",""],
            ["[63] CBS-Oversterfte","cbs_oversterfte","Terug naar de tekentafel: oversterfte-analyse met CBS-data"],
            ]
