...
def plot_wrapper(df_boosters, df_herhaalprik, df_herfstprik, df_rioolwater, df_,   df_corona, df_quantile,     df_kobak, series_name, how, yaxis_to_zero, rightax, mergetype, sec_y):
...
def get_sterftedata(seriename="m_v_0_999"):
    ...
    df_[['weeknr','delete']] = df_.weeknr.str.split(" \(",expand=True,)
...
def main():
    ...
    df_sterfte, df_boosters,df_herhaalprik,df_herfstprik,df_rioolwater, df_kobak = get_all_data(series_name)
    ...
    plot_wrapper(df_boosters, df_herhaalprik, df_herfstprik, df_rioolwater, df_sterfte,df_corona, df_quantile, df_kobak, series_name, how, yaxis_to_zero, rightax, mergetype, sec_y)
    if how == "quantiles":
