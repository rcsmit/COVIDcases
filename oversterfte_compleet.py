...
from oversterfte_plot_functions import plot_wrapper, show_plot_steigstra, plot_graph_rivm, show_difference_plot
...
def get_sterftedata(vanaf_jaar, seriename="m_v_0_999", ):
    """Get and manipulate data of the deaths with CBSOdata
...
def main():
    ...
    df_sterfte = get_sterftedata(vanaf_jaar, series_name)
