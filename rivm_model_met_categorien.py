...
DEFAULT_INPUT_URL = (
    ...
    "overlijdens_per_week_2014_2025_met_categorien.csv"
)
DEFAULT_INPUT_URL=r"C:\Users\rcxsm\Documents\python_scripts\covid19_seir_models\COVIDcases\input\overlijdens_per_week_2014_2025_met_categorien.csv"
#C:\Users\rcxsm\Documents\python_scripts\covid19_seir_models\COVIDcases\input\overlijdens_per_week_2014_2025.csv
RIVM_OFFICIAL_URL = (
    "https://raw.githubusercontent.com/rcsmit/COVIDcases/refs/heads/main/input/"
...
def load_data_from_url(keuze,url: str = DEFAULT_INPUT_URL) -> pd.DataFrame:
...
# --------------------------------------------------------------------------------------
def main_grok(keuze, q_all: float, q_summer: float) -> None:
...
def main() -> None:
    ...
    with st.expander("Opties"):
        keuze=st.selectbox("Leeftijd",["Totaal leeftijd","0 tot 65 jaar","65 tot 80 jaar","80 jaar of ouder","overleden origineel"])
    ...
    df = load_data_from_url(keuze,DEFAULT_INPUT_URL)
    ...
    with tab4:
        main_grok(keuze,q_all=q_all, q_summer=q_summer)
